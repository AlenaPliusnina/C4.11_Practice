...
<!-- <template>
  <div class="container">
    <div class="col-sm-10">
      ...
      v-b-modal.todo-modal @click="buttonAddOnClick"> Добавить задачу
      </button>
          ...
          <tr v-for="(todo, index) in todos" :key="index">
            ...
            <td>
              <div class="btn-group" role="group">
                ...
                v-b-modal.todo-modal @click="updateTodo(todo)"> Обновить
                </button>
                &nbsp;
                <button type="button" class="btn btn-danger btn-sm" @click="deleteTodo(todo)">
                  X
      ...
      <!-- <b-modal ref="TodoModalChanges" id="todo-modal" :title="title_name" hide-footer>
        <b-form @submit="onSubmit" @reset="onReset" class="w-100">
          <b-form-group id="form-description-group" label="Описание:"
          label-for="form-description-input">
            <b-form-input id="form-description-input" type="text" v-model="addTodoForm.description"
            required :placeholder="placeholder_content" :value="descript">
            </b-form-input>
          </b-form-group>
          <b-form-group id="form-complete-group">
            <b-form-checkbox-group v-model="addTodoForm.is_completed" id="form-checks">
          ...
          <b-button class="m-2" type="submit" variant="primary">{{title_name}}</b-button>
          <b-button type="reset" variant="danger">Сброс</b-button>
        </b-form>
      </b-modal> -->

      <!-- <b-modal ref="updateTodoModal" id="todo-update-modal"  hide-footer>
        <b-form @submit="onUpdateSubmit" @reset="onUpdateReset" class="w-100">
        <b-form-group id="form-update-description-group" label="Описание:"
        label-for="form-update-description-input">
          <b-form-input id="form-update-description-input" type="text"
...
//       descript: '',
//       complete: '',
//       // model: this.addTodoForm.description,
//     };
//   },
//   methods: {
//     buttonAddOnClick() {
//       this.title_name = 'Добавить';
//       this.placeholder_content = 'Завести задачу';
//       this.descript = this.addTodoForm.description;
//       this.complete = this.addTodoForm.is_completed;
//     },
//     updateTodo(todo) {
//       this.title_name = 'Обновить';
//       this.placeholder_content = '';
//       this.descript = this.updateTodoForm.description;
//       this.complete = this.updateTodoForm.is_completed;
//       this.updateTodoForm.description = todo.description;
//       this.updateTodoForm.uid = todo.uid;
//       if (todo.is_completed) {
//         this.updateTodoForm.is_completed = [true];
...
//     onSubmit(event) {
//       event.preventDefault();
//       this.$refs.TodoModalChanges.hide();
//       const requestData = {
//         description: this.addTodoForm.description,
//         is_completed: this.addTodoForm.is_completed.length > 0,
//       };
